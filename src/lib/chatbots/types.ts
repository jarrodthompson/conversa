...
export const NODE_DEFS: Record<NodeType, NodeDef> = {
  ...
  ai_response: { type: "ai_response", label: "AI Response", icon: Sparkles, color: "#06B6D4", category: "AI", handles: OUT, description: "Generate a grounded AI reply (demo).", defaultData: { agent: "" } },
