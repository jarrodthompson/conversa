...
export const NODE_DEFS: Record<NodeType, NodeDef> = {
  ...
  multiple_choice: { type: "multiple_choice", label: "Multiple Choice", icon: ListChecks, color: "#6366F1", category: "Messaging", handles: OUT, description: "Show options as buttons, then continue.", defaultData: { prompt: "Choose an option:", options: ["Track order", "Returns", "Talk to a human"] } },
